...
<body>
        ...
        <div class="mx-auto container">
            <form id="checkout-form">
                <div class="form-group checkout-small-element">
                    <label> Total</label>
                    <input type="text" class="form-control" id="checkout-total" name="total" value="<?php echo $total; ?>" readonly>
                </div>
                <div>
    ...
    <script>
        ...
        function checkout() {
            ...
            window.location.href = 'cart.php?cart-total=' + total;
        }
    </script>
